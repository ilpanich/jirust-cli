...
pub enum GetAllSystemAvatarsSuccess {
    Status200(models::SystemAvatars),
    UnknownValue(serde_json::Value),
}
...
pub async fn delete_avatar(configuration: &configuration::Configuration, r#type: &str, owning_object_id: &str, id: i64) -> Result<ResponseContent<DeleteAvatarSuccess>, Error<DeleteAvatarError>> {
...
pub async fn get_all_system_avatars(configuration: &configuration::Configuration, r#type: &str) -> Result<ResponseContent<GetAllSystemAvatarsSuccess>, Error<GetAllSystemAvatarsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_avatar_image_by_id(configuration: &configuration::Configuration, r#type: &str, id: i64, size: Option<&str>, format: Option<&str>) -> Result<ResponseContent<GetAvatarImageByIdSuccess>, Error<GetAvatarImageByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_avatar_image_by_owner(configuration: &configuration::Configuration, r#type: &str, entity_id: &str, size: Option<&str>, format: Option<&str>) -> Result<ResponseContent<GetAvatarImageByOwnerSuccess>, Error<GetAvatarImageByOwnerError>> {
    let local_var_configuration = configuration;
...
pub async fn get_avatar_image_by_type(configuration: &configuration::Configuration, r#type: &str, size: Option<&str>, format: Option<&str>) -> Result<ResponseContent<GetAvatarImageByTypeSuccess>, Error<GetAvatarImageByTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_avatars(configuration: &configuration::Configuration, r#type: &str, entity_id: &str) -> Result<ResponseContent<GetAvatarsSuccess>, Error<GetAvatarsError>> {
    let local_var_configuration = configuration;
...
pub async fn store_avatar(configuration: &configuration::Configuration, r#type: &str, entity_id: &str, size: i32, body: Option<serde_json::Value>, x: Option<i32>, y: Option<i32>) -> Result<ResponseContent<StoreAvatarSuccess>, Error<StoreAvatarError>> {
    let local_var_configuration = configuration;
