...
/// struct for typed successes of method [`create_statuses`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateStatusesSuccess {
    Status200(Vec<models::JiraStatus>),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`delete_statuses_by_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteStatusesByIdSuccess {
    Status204(serde_json::Value),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_statuses_by_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetStatusesByIdSuccess {
    Status200(Vec<models::JiraStatus>),
    UnknownValue(serde_json::Value),
}
...
pub enum SearchSuccess {
    Status200(models::PageOfStatuses),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`update_statuses`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateStatusesSuccess {
    Status204(serde_json::Value),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_statuses(configuration: &configuration::Configuration, status_create_request: models::StatusCreateRequest) -> Result<ResponseContent<CreateStatusesSuccess>, Error<CreateStatusesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateStatusesSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_statuses_by_id(configuration: &configuration::Configuration, id: Vec<String>) -> Result<ResponseContent<DeleteStatusesByIdSuccess>, Error<DeleteStatusesByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteStatusesByIdSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_statuses_by_id(configuration: &configuration::Configuration, id: Vec<String>, expand: Option<&str>) -> Result<ResponseContent<GetStatusesByIdSuccess>, Error<GetStatusesByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetStatusesByIdSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn search(configuration: &configuration::Configuration, expand: Option<&str>, project_id: Option<&str>, start_at: Option<i64>, max_results: Option<i32>, search_string: Option<&str>, status_category: Option<&str>) -> Result<ResponseContent<SearchSuccess>, Error<SearchError>> {
    let local_var_configuration = configuration;
...
pub async fn update_statuses(configuration: &configuration::Configuration, status_update_request: models::StatusUpdateRequest) -> Result<ResponseContent<UpdateStatusesSuccess>, Error<UpdateStatusesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateStatusesSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
