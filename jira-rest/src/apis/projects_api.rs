...
pub enum CreateProjectSuccess {
    Status201(models::ProjectIdentifiers),
    UnknownValue(serde_json::Value),
}
...
pub enum GetAllStatusesSuccess {
    Status200(Vec<models::IssueTypeWithStatus>),
    UnknownValue(serde_json::Value),
}
...
pub enum GetHierarchySuccess {
    Status200(models::ProjectIssueTypeHierarchy),
    UnknownValue(serde_json::Value),
}
...
pub async fn archive_project(configuration: &configuration::Configuration, project_id_or_key: &str) -> Result<ResponseContent<ArchiveProjectSuccess>, Error<ArchiveProjectError>> {
...
pub async fn create_project(configuration: &configuration::Configuration, create_project_details: models::CreateProjectDetails) -> Result<ResponseContent<CreateProjectSuccess>, Error<CreateProjectError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_project(configuration: &configuration::Configuration, project_id_or_key: &str, enable_undo: Option<bool>) -> Result<ResponseContent<DeleteProjectSuccess>, Error<DeleteProjectError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_project_asynchronously(configuration: &configuration::Configuration, project_id_or_key: &str) -> Result<ResponseContent<DeleteProjectAsynchronouslySuccess>, Error<DeleteProjectAsynchronouslyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_projects(configuration: &configuration::Configuration, expand: Option<&str>, recent: Option<i32>, properties: Option<Vec<String>>) -> Result<ResponseContent<GetAllProjectsSuccess>, Error<GetAllProjectsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_statuses(configuration: &configuration::Configuration, project_id_or_key: &str) -> Result<ResponseContent<GetAllStatusesSuccess>, Error<GetAllStatusesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_hierarchy(configuration: &configuration::Configuration, project_id: i64) -> Result<ResponseContent<GetHierarchySuccess>, Error<GetHierarchyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_notification_scheme_for_project(configuration: &configuration::Configuration, project_key_or_id: &str, expand: Option<&str>) -> Result<ResponseContent<GetNotificationSchemeForProjectSuccess>, Error<GetNotificationSchemeForProjectError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project(configuration: &configuration::Configuration, project_id_or_key: &str, expand: Option<&str>, properties: Option<Vec<String>>) -> Result<ResponseContent<GetProjectSuccess>, Error<GetProjectError>> {
    let local_var_configuration = configuration;
...
pub async fn get_recent(configuration: &configuration::Configuration, expand: Option<&str>, properties: Option<Vec<serde_json::Value>>) -> Result<ResponseContent<GetRecentSuccess>, Error<GetRecentError>> {
    let local_var_configuration = configuration;
...
pub async fn restore(configuration: &configuration::Configuration, project_id_or_key: &str) -> Result<ResponseContent<RestoreSuccess>, Error<RestoreError>> {
    let local_var_configuration = configuration;
...
pub async fn search_projects(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, order_by: Option<&str>, id: Option<Vec<i64>>, keys: Option<Vec<String>>, query: Option<&str>, type_key: Option<&str>, category_id: Option<i64>, action: Option<&str>, expand: Option<&str>, status: Option<Vec<String>>, properties: Option<Vec<serde_json::Value>>, property_query: Option<&str>) -> Result<ResponseContent<SearchProjectsSuccess>, Error<SearchProjectsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_project(configuration: &configuration::Configuration, project_id_or_key: &str, update_project_details: models::UpdateProjectDetails, expand: Option<&str>) -> Result<ResponseContent<UpdateProjectSuccess>, Error<UpdateProjectError>> {
    let local_var_configuration = configuration;
