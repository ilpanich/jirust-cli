...
pub enum GetAllWorkflowSchemesSuccess {
    Status200(models::PageBeanWorkflowScheme),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`read_workflow_schemes`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReadWorkflowSchemesSuccess {
    Status200(Vec<models::WorkflowSchemeReadResponse>),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`update_schemes`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateSchemesSuccess {
...
/// struct for typed successes of method [`update_workflow_scheme_mappings`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateWorkflowSchemeMappingsSuccess {
    Status200(models::WorkflowSchemeUpdateRequiredMappingsResponse),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_workflow_scheme(configuration: &configuration::Configuration, workflow_scheme: models::WorkflowScheme) -> Result<ResponseContent<CreateWorkflowSchemeSuccess>, Error<CreateWorkflowSchemeError>> {
...
pub async fn delete_default_workflow(configuration: &configuration::Configuration, id: i64, update_draft_if_needed: Option<bool>) -> Result<ResponseContent<DeleteDefaultWorkflowSuccess>, Error<DeleteDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_mapping(configuration: &configuration::Configuration, id: i64, workflow_name: &str, update_draft_if_needed: Option<bool>) -> Result<ResponseContent<DeleteWorkflowMappingSuccess>, Error<DeleteWorkflowMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_scheme(configuration: &configuration::Configuration, id: i64) -> Result<ResponseContent<DeleteWorkflowSchemeSuccess>, Error<DeleteWorkflowSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_scheme_issue_type(configuration: &configuration::Configuration, id: i64, issue_type: &str, update_draft_if_needed: Option<bool>) -> Result<ResponseContent<DeleteWorkflowSchemeIssueTypeSuccess>, Error<DeleteWorkflowSchemeIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_workflow_schemes(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>) -> Result<ResponseContent<GetAllWorkflowSchemesSuccess>, Error<GetAllWorkflowSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_default_workflow(configuration: &configuration::Configuration, id: i64, return_draft_if_exists: Option<bool>) -> Result<ResponseContent<GetDefaultWorkflowSuccess>, Error<GetDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow(configuration: &configuration::Configuration, id: i64, workflow_name: Option<&str>, return_draft_if_exists: Option<bool>) -> Result<ResponseContent<GetWorkflowSuccess>, Error<GetWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme(configuration: &configuration::Configuration, id: i64, return_draft_if_exists: Option<bool>) -> Result<ResponseContent<GetWorkflowSchemeSuccess>, Error<GetWorkflowSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme_issue_type(configuration: &configuration::Configuration, id: i64, issue_type: &str, return_draft_if_exists: Option<bool>) -> Result<ResponseContent<GetWorkflowSchemeIssueTypeSuccess>, Error<GetWorkflowSchemeIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn read_workflow_schemes(configuration: &configuration::Configuration, workflow_scheme_read_request: models::WorkflowSchemeReadRequest, expand: Option<&str>) -> Result<ResponseContent<ReadWorkflowSchemesSuccess>, Error<ReadWorkflowSchemesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ReadWorkflowSchemesSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn set_workflow_scheme_issue_type(configuration: &configuration::Configuration, id: i64, issue_type: &str, issue_type_workflow_mapping: models::IssueTypeWorkflowMapping) -> Result<ResponseContent<SetWorkflowSchemeIssueTypeSuccess>, Error<SetWorkflowSchemeIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn update_default_workflow(configuration: &configuration::Configuration, id: i64, default_workflow: models::DefaultWorkflow) -> Result<ResponseContent<UpdateDefaultWorkflowSuccess>, Error<UpdateDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn update_schemes(configuration: &configuration::Configuration, workflow_scheme_update_request: models::WorkflowSchemeUpdateRequest) -> Result<ResponseContent<UpdateSchemesSuccess>, Error<UpdateSchemesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateSchemesSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn update_workflow_mapping(configuration: &configuration::Configuration, id: i64, workflow_name: &str, issue_types_workflow_mapping: models::IssueTypesWorkflowMapping) -> Result<ResponseContent<UpdateWorkflowMappingSuccess>, Error<UpdateWorkflowMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow_scheme(configuration: &configuration::Configuration, id: i64, workflow_scheme: models::WorkflowScheme) -> Result<ResponseContent<UpdateWorkflowSchemeSuccess>, Error<UpdateWorkflowSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow_scheme_mappings(configuration: &configuration::Configuration, workflow_scheme_update_required_mappings_request: models::WorkflowSchemeUpdateRequiredMappingsRequest) -> Result<ResponseContent<UpdateWorkflowSchemeMappingsSuccess>, Error<UpdateWorkflowSchemeMappingsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateWorkflowSchemeMappingsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
