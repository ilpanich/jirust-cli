...
/// struct for typed successes of method [`get_bulk_editable_fields`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetBulkEditableFieldsSuccess {
    Status200(models::BulkEditGetFields),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_bulk_operation_progress`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetBulkOperationProgressSuccess {
    Status200(models::BulkOperationProgress),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`submit_bulk_edit`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SubmitBulkEditSuccess {
    Status201(models::SubmittedBulkOperation),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`submit_bulk_move`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SubmitBulkMoveSuccess {
    Status200(models::SubmittedBulkOperation),
    UnknownValue(serde_json::Value),
}
...
pub async fn get_bulk_editable_fields(configuration: &configuration::Configuration, issue_ids_or_keys: &str, search_text: Option<&str>, ending_before: Option<&str>, starting_after: Option<&str>) -> Result<ResponseContent<GetBulkEditableFieldsSuccess>, Error<GetBulkEditableFieldsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetBulkEditableFieldsSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_bulk_operation_progress(configuration: &configuration::Configuration, task_id: &str) -> Result<ResponseContent<GetBulkOperationProgressSuccess>, Error<GetBulkOperationProgressError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetBulkOperationProgressSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn submit_bulk_edit(configuration: &configuration::Configuration, issue_bulk_edit_payload: models::IssueBulkEditPayload, send_bulk_notification: Option<bool>) -> Result<ResponseContent<SubmitBulkEditSuccess>, Error<SubmitBulkEditError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<SubmitBulkEditSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn submit_bulk_move(configuration: &configuration::Configuration, issue_bulk_move_payload: models::IssueBulkMovePayload) -> Result<ResponseContent<SubmitBulkMoveSuccess>, Error<SubmitBulkMoveError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<SubmitBulkMoveSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
