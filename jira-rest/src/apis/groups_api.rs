...
/// struct for typed successes of method [`add_user_to_group`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddUserToGroupSuccess {
    Status201(models::Group),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`bulk_get_groups`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum BulkGetGroupsSuccess {
    Status200(models::PageBeanGroupDetails),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`create_group`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateGroupSuccess {
    Status201(models::Group),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`find_groups`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FindGroupsSuccess {
    Status200(models::FoundGroups),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_group`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetGroupSuccess {
    Status200(models::Group),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_users_from_group`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetUsersFromGroupSuccess {
    Status200(models::PageBeanUserDetails),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`remove_group`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RemoveGroupSuccess {
    Status200(),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`remove_user_from_group`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RemoveUserFromGroupSuccess {
    Status200(),
    UnknownValue(serde_json::Value),
}
...
pub async fn add_user_to_group(configuration: &configuration::Configuration, update_user_to_group_bean: models::UpdateUserToGroupBean, groupname: Option<&str>, group_id: Option<&str>) -> Result<ResponseContent<AddUserToGroupSuccess>, Error<AddUserToGroupError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<AddUserToGroupSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn bulk_get_groups(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, group_id: Option<Vec<String>>, group_name: Option<Vec<String>>, access_type: Option<&str>, application_key: Option<&str>) -> Result<ResponseContent<BulkGetGroupsSuccess>, Error<BulkGetGroupsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<BulkGetGroupsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn create_group(configuration: &configuration::Configuration, add_group_bean: models::AddGroupBean) -> Result<ResponseContent<CreateGroupSuccess>, Error<CreateGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateGroupSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn find_groups(configuration: &configuration::Configuration, account_id: Option<&str>, query: Option<&str>, exclude: Option<Vec<String>>, exclude_id: Option<Vec<String>>, max_results: Option<i32>, case_insensitive: Option<bool>, user_name: Option<&str>) -> Result<ResponseContent<FindGroupsSuccess>, Error<FindGroupsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FindGroupsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_group(configuration: &configuration::Configuration, groupname: Option<&str>, group_id: Option<&str>, expand: Option<&str>) -> Result<ResponseContent<GetGroupSuccess>, Error<GetGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetGroupSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_users_from_group(configuration: &configuration::Configuration, groupname: Option<&str>, group_id: Option<&str>, include_inactive_users: Option<bool>, start_at: Option<i64>, max_results: Option<i32>) -> Result<ResponseContent<GetUsersFromGroupSuccess>, Error<GetUsersFromGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetUsersFromGroupSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn remove_group(configuration: &configuration::Configuration, groupname: Option<&str>, group_id: Option<&str>, swap_group: Option<&str>, swap_group_id: Option<&str>) -> Result<ResponseContent<RemoveGroupSuccess>, Error<RemoveGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<RemoveGroupSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn remove_user_from_group(configuration: &configuration::Configuration, account_id: &str, groupname: Option<&str>, group_id: Option<&str>, username: Option<&str>) -> Result<ResponseContent<RemoveUserFromGroupSuccess>, Error<RemoveUserFromGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<RemoveUserFromGroupSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
