...
/// struct for typed successes of method [`add_vote`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddVoteSuccess {
    Status204(serde_json::Value),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_votes`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetVotesSuccess {
    Status200(models::Votes),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`remove_vote`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RemoveVoteSuccess {
    Status204(),
    UnknownValue(serde_json::Value),
}
...
pub async fn add_vote(configuration: &configuration::Configuration, issue_id_or_key: &str) -> Result<ResponseContent<AddVoteSuccess>, Error<AddVoteError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<AddVoteSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_votes(configuration: &configuration::Configuration, issue_id_or_key: &str) -> Result<ResponseContent<GetVotesSuccess>, Error<GetVotesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetVotesSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn remove_vote(configuration: &configuration::Configuration, issue_id_or_key: &str) -> Result<ResponseContent<RemoveVoteSuccess>, Error<RemoveVoteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<RemoveVoteSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
