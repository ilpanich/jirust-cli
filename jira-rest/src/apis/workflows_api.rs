...
pub enum CreateWorkflowSuccess {
    Status201(models::WorkflowIds),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`create_workflows`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateWorkflowsSuccess {
    Status200(models::WorkflowCreateResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`delete_inactive_workflow`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteInactiveWorkflowSuccess {
    Status204(),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_all_workflows`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetAllWorkflowsSuccess {
    Status200(Vec<models::DeprecatedWorkflow>),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_workflows_paginated`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetWorkflowsPaginatedSuccess {
    Status200(models::PageBeanWorkflow),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`read_workflows`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReadWorkflowsSuccess {
    Status200(models::WorkflowReadResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`update_workflows`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateWorkflowsSuccess {
    Status200(models::WorkflowUpdateResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`validate_create_workflows`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ValidateCreateWorkflowsSuccess {
    Status200(models::WorkflowValidationErrorList),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`validate_update_workflows`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ValidateUpdateWorkflowsSuccess {
    Status200(models::WorkflowValidationErrorList),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`workflow_capabilities`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum WorkflowCapabilitiesSuccess {
    Status200(models::WorkflowCapabilities),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_workflow(configuration: &configuration::Configuration, create_workflow_details: models::CreateWorkflowDetails) -> Result<ResponseContent<CreateWorkflowSuccess>, Error<CreateWorkflowError>> {
...
pub async fn create_workflows(configuration: &configuration::Configuration, workflow_create_request: models::WorkflowCreateRequest) -> Result<ResponseContent<CreateWorkflowsSuccess>, Error<CreateWorkflowsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateWorkflowsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn delete_inactive_workflow(configuration: &configuration::Configuration, entity_id: &str) -> Result<ResponseContent<DeleteInactiveWorkflowSuccess>, Error<DeleteInactiveWorkflowError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteInactiveWorkflowSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_all_workflows(configuration: &configuration::Configuration, workflow_name: Option<&str>) -> Result<ResponseContent<GetAllWorkflowsSuccess>, Error<GetAllWorkflowsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetAllWorkflowsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_workflows_paginated(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, workflow_name: Option<Vec<String>>, expand: Option<&str>, query_string: Option<&str>, order_by: Option<&str>, is_active: Option<bool>) -> Result<ResponseContent<GetWorkflowsPaginatedSuccess>, Error<GetWorkflowsPaginatedError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetWorkflowsPaginatedSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn read_workflows(configuration: &configuration::Configuration, workflow_read_request: models::WorkflowReadRequest, expand: Option<&str>, use_transition_links_format: Option<bool>) -> Result<ResponseContent<ReadWorkflowsSuccess>, Error<ReadWorkflowsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ReadWorkflowsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn update_workflows(configuration: &configuration::Configuration, workflow_update_request: models::WorkflowUpdateRequest, expand: Option<&str>) -> Result<ResponseContent<UpdateWorkflowsSuccess>, Error<UpdateWorkflowsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateWorkflowsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn validate_create_workflows(configuration: &configuration::Configuration, workflow_create_validate_request: models::WorkflowCreateValidateRequest) -> Result<ResponseContent<ValidateCreateWorkflowsSuccess>, Error<ValidateCreateWorkflowsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ValidateCreateWorkflowsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn validate_update_workflows(configuration: &configuration::Configuration, workflow_update_validate_request_bean: models::WorkflowUpdateValidateRequestBean) -> Result<ResponseContent<ValidateUpdateWorkflowsSuccess>, Error<ValidateUpdateWorkflowsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ValidateUpdateWorkflowsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn workflow_capabilities(configuration: &configuration::Configuration, workflow_id: Option<&str>, project_id: Option<&str>, issue_type_id: Option<&str>) -> Result<ResponseContent<WorkflowCapabilitiesSuccess>, Error<WorkflowCapabilitiesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<WorkflowCapabilitiesSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
