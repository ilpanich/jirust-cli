...
pub enum DeleteWorkflowTransitionRuleConfigurationsSuccess {
    Status200(models::WorkflowTransitionRulesUpdateErrors),
...
pub enum GetWorkflowTransitionRuleConfigurationsSuccess {
    Status200(models::PageBeanWorkflowTransitionRules),
    UnknownValue(serde_json::Value),
}
...
pub async fn delete_workflow_transition_rule_configurations(configuration: &configuration::Configuration, workflows_with_transition_rules_details: models::WorkflowsWithTransitionRulesDetails) -> Result<ResponseContent<DeleteWorkflowTransitionRuleConfigurationsSuccess>, Error<DeleteWorkflowTransitionRuleConfigurationsError>> {
...
pub async fn update_workflow_transition_rule_configurations(configuration: &configuration::Configuration, workflow_transition_rules_update: models::WorkflowTransitionRulesUpdate) -> Result<ResponseContent<UpdateWorkflowTransitionRuleConfigurationsSuccess>, Error<UpdateWorkflowTransitionRuleConfigurationsError>> {
    let local_var_configuration = configuration;
