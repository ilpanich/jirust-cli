...
/// struct for typed successes of method [`add_actor_users`]
...
/// struct for typed successes of method [`add_project_role_actors_to_role`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed successes of method [`delete_actor`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed successes of method [`delete_project_role_actors_from_role`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed successes of method [`get_project_role_actors_for_role`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed successes of method [`set_actors`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn add_actor_users(configuration: &configuration::Configuration, project_id_or_key: &str, id: i64, actors_map: models::ActorsMap) -> Result<ResponseContent<AddActorUsersSuccess>, Error<AddActorUsersError>> {
...
pub async fn add_project_role_actors_to_role(configuration: &configuration::Configuration, id: i64, actor_input_bean: models::ActorInputBean) -> Result<ResponseContent<AddProjectRoleActorsToRoleSuccess>, Error<AddProjectRoleActorsToRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_actor(configuration: &configuration::Configuration, project_id_or_key: &str, id: i64, user: Option<&str>, group: Option<&str>, group_id: Option<&str>) -> Result<ResponseContent<DeleteActorSuccess>, Error<DeleteActorError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_project_role_actors_from_role(configuration: &configuration::Configuration, id: i64, user: Option<&str>, group_id: Option<&str>, group: Option<&str>) -> Result<ResponseContent<DeleteProjectRoleActorsFromRoleSuccess>, Error<DeleteProjectRoleActorsFromRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_role_actors_for_role(configuration: &configuration::Configuration, id: i64) -> Result<ResponseContent<GetProjectRoleActorsForRoleSuccess>, Error<GetProjectRoleActorsForRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn set_actors(configuration: &configuration::Configuration, project_id_or_key: &str, id: i64, project_role_actors_update_bean: models::ProjectRoleActorsUpdateBean) -> Result<ResponseContent<SetActorsSuccess>, Error<SetActorsError>> {
    let local_var_configuration = configuration;
