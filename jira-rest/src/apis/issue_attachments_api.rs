...
/// struct for typed successes of method [`add_attachment`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddAttachmentSuccess {
    Status200(Vec<models::Attachment>),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`expand_attachment_for_humans`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ExpandAttachmentForHumansSuccess {
    Status200(models::AttachmentArchiveMetadataReadable),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`expand_attachment_for_machines`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ExpandAttachmentForMachinesSuccess {
    Status200(models::AttachmentArchiveImpl),
    UnknownValue(serde_json::Value),
}
...
pub enum GetAttachmentSuccess {
    Status200(models::AttachmentMetadata),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_attachment_content`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetAttachmentContentSuccess {
    Status200(Vec<serde_json::Value>),
    Status206(),
    Status303(),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_attachment_meta`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetAttachmentMetaSuccess {
    Status200(models::AttachmentSettings),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_attachment_thumbnail`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetAttachmentThumbnailSuccess {
    Status200(Vec<serde_json::Value>),
    Status303(),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`remove_attachment`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RemoveAttachmentSuccess {
    Status204(),
    UnknownValue(serde_json::Value),
}
...
pub async fn add_attachment(configuration: &configuration::Configuration, issue_id_or_key: &str) -> Result<ResponseContent<AddAttachmentSuccess>, Error<AddAttachmentError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<AddAttachmentSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn expand_attachment_for_humans(configuration: &configuration::Configuration, id: &str) -> Result<ResponseContent<ExpandAttachmentForHumansSuccess>, Error<ExpandAttachmentForHumansError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ExpandAttachmentForHumansSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn expand_attachment_for_machines(configuration: &configuration::Configuration, id: &str) -> Result<ResponseContent<ExpandAttachmentForMachinesSuccess>, Error<ExpandAttachmentForMachinesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ExpandAttachmentForMachinesSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_attachment(configuration: &configuration::Configuration, id: &str) -> Result<ResponseContent<GetAttachmentSuccess>, Error<GetAttachmentError>> {
    let local_var_configuration = configuration;
...
pub async fn get_attachment_content(configuration: &configuration::Configuration, id: &str, redirect: Option<bool>) -> Result<ResponseContent<GetAttachmentContentSuccess>, Error<GetAttachmentContentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetAttachmentContentSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_attachment_meta(configuration: &configuration::Configuration, ) -> Result<ResponseContent<GetAttachmentMetaSuccess>, Error<GetAttachmentMetaError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetAttachmentMetaSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_attachment_thumbnail(configuration: &configuration::Configuration, id: &str, redirect: Option<bool>, fallback_to_default: Option<bool>, width: Option<i32>, height: Option<i32>) -> Result<ResponseContent<GetAttachmentThumbnailSuccess>, Error<GetAttachmentThumbnailError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetAttachmentThumbnailSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn remove_attachment(configuration: &configuration::Configuration, id: &str) -> Result<ResponseContent<RemoveAttachmentSuccess>, Error<RemoveAttachmentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<RemoveAttachmentSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
