...
/// struct for typed successes of method [`add_notifications`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddNotificationsSuccess {
    Status204(serde_json::Value),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`create_notification_scheme`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateNotificationSchemeSuccess {
    Status201(models::NotificationSchemeId),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`delete_notification_scheme`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteNotificationSchemeSuccess {
    Status204(serde_json::Value),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_notification_scheme`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetNotificationSchemeSuccess {
    Status200(models::NotificationScheme),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_notification_scheme_to_project_mappings`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetNotificationSchemeToProjectMappingsSuccess {
    Status200(models::PageBeanNotificationSchemeAndProjectMappingJsonBean),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_notification_schemes`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetNotificationSchemesSuccess {
    Status200(models::PageBeanNotificationScheme),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`remove_notification_from_notification_scheme`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RemoveNotificationFromNotificationSchemeSuccess {
    Status204(serde_json::Value),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`update_notification_scheme`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateNotificationSchemeSuccess {
    Status204(serde_json::Value),
    UnknownValue(serde_json::Value),
}
...
pub async fn add_notifications(configuration: &configuration::Configuration, id: &str, add_notifications_details: models::AddNotificationsDetails) -> Result<ResponseContent<AddNotificationsSuccess>, Error<AddNotificationsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<AddNotificationsSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn create_notification_scheme(configuration: &configuration::Configuration, create_notification_scheme_details: models::CreateNotificationSchemeDetails) -> Result<ResponseContent<CreateNotificationSchemeSuccess>, Error<CreateNotificationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateNotificationSchemeSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn delete_notification_scheme(configuration: &configuration::Configuration, notification_scheme_id: &str) -> Result<ResponseContent<DeleteNotificationSchemeSuccess>, Error<DeleteNotificationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteNotificationSchemeSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_notification_scheme(configuration: &configuration::Configuration, id: i64, expand: Option<&str>) -> Result<ResponseContent<GetNotificationSchemeSuccess>, Error<GetNotificationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetNotificationSchemeSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_notification_scheme_to_project_mappings(configuration: &configuration::Configuration, start_at: Option<&str>, max_results: Option<&str>, notification_scheme_id: Option<Vec<String>>, project_id: Option<Vec<String>>) -> Result<ResponseContent<GetNotificationSchemeToProjectMappingsSuccess>, Error<GetNotificationSchemeToProjectMappingsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetNotificationSchemeToProjectMappingsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_notification_schemes(configuration: &configuration::Configuration, start_at: Option<&str>, max_results: Option<&str>, id: Option<Vec<String>>, project_id: Option<Vec<String>>, only_default: Option<bool>, expand: Option<&str>) -> Result<ResponseContent<GetNotificationSchemesSuccess>, Error<GetNotificationSchemesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetNotificationSchemesSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn remove_notification_from_notification_scheme(configuration: &configuration::Configuration, notification_scheme_id: &str, notification_id: &str) -> Result<ResponseContent<RemoveNotificationFromNotificationSchemeSuccess>, Error<RemoveNotificationFromNotificationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<RemoveNotificationFromNotificationSchemeSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn update_notification_scheme(configuration: &configuration::Configuration, id: &str, update_notification_scheme_details: models::UpdateNotificationSchemeDetails) -> Result<ResponseContent<UpdateNotificationSchemeSuccess>, Error<UpdateNotificationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateNotificationSchemeSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
