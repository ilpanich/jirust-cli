...
pub async fn get_audit_records(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, filter: Option<&str>, from: Option<&str>, to: Option<&str>) -> Result<ResponseContent<GetAuditRecordsSuccess>, Error<GetAuditRecordsError>> {
