...
/// struct for typed successes of method [`create_issue_field_option`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateIssueFieldOptionSuccess {
    Status200(models::IssueFieldOption),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`delete_issue_field_option`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteIssueFieldOptionSuccess {
    Status204(serde_json::Value),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_all_issue_field_options`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetAllIssueFieldOptionsSuccess {
    Status200(models::PageBeanIssueFieldOption),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_issue_field_option`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetIssueFieldOptionSuccess {
    Status200(models::IssueFieldOption),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_selectable_issue_field_options`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSelectableIssueFieldOptionsSuccess {
    Status200(models::PageBeanIssueFieldOption),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_visible_issue_field_options`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetVisibleIssueFieldOptionsSuccess {
    Status200(models::PageBeanIssueFieldOption),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`replace_issue_field_option`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReplaceIssueFieldOptionSuccess {
    Status303(models::TaskProgressBeanRemoveOptionFromIssuesResult),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`update_issue_field_option`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateIssueFieldOptionSuccess {
    Status200(models::IssueFieldOption),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_issue_field_option(configuration: &configuration::Configuration, field_key: &str, issue_field_option_create_bean: models::IssueFieldOptionCreateBean) -> Result<ResponseContent<CreateIssueFieldOptionSuccess>, Error<CreateIssueFieldOptionError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateIssueFieldOptionSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_issue_field_option(configuration: &configuration::Configuration, field_key: &str, option_id: i64) -> Result<ResponseContent<DeleteIssueFieldOptionSuccess>, Error<DeleteIssueFieldOptionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteIssueFieldOptionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_all_issue_field_options(configuration: &configuration::Configuration, field_key: &str, start_at: Option<i64>, max_results: Option<i32>) -> Result<ResponseContent<GetAllIssueFieldOptionsSuccess>, Error<GetAllIssueFieldOptionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetAllIssueFieldOptionsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_issue_field_option(configuration: &configuration::Configuration, field_key: &str, option_id: i64) -> Result<ResponseContent<GetIssueFieldOptionSuccess>, Error<GetIssueFieldOptionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetIssueFieldOptionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_selectable_issue_field_options(configuration: &configuration::Configuration, field_key: &str, start_at: Option<i64>, max_results: Option<i32>, project_id: Option<i64>) -> Result<ResponseContent<GetSelectableIssueFieldOptionsSuccess>, Error<GetSelectableIssueFieldOptionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetSelectableIssueFieldOptionsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_visible_issue_field_options(configuration: &configuration::Configuration, field_key: &str, start_at: Option<i64>, max_results: Option<i32>, project_id: Option<i64>) -> Result<ResponseContent<GetVisibleIssueFieldOptionsSuccess>, Error<GetVisibleIssueFieldOptionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetVisibleIssueFieldOptionsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn replace_issue_field_option(configuration: &configuration::Configuration, field_key: &str, option_id: i64, replace_with: Option<i64>, jql: Option<&str>, override_screen_security: Option<bool>, override_editable_flag: Option<bool>) -> Result<ResponseContent<ReplaceIssueFieldOptionSuccess>, Error<ReplaceIssueFieldOptionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ReplaceIssueFieldOptionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn update_issue_field_option(configuration: &configuration::Configuration, field_key: &str, option_id: i64, issue_field_option: models::IssueFieldOption) -> Result<ResponseContent<UpdateIssueFieldOptionSuccess>, Error<UpdateIssueFieldOptionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateIssueFieldOptionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
