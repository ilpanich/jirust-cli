...
/// struct for typed successes of method [`delete_locale`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteLocaleSuccess {
...
/// struct for typed successes of method [`get_locale`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetLocaleSuccess {
    Status200(models::Locale),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_preference`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetPreferenceSuccess {
    Status200(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`remove_preference`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RemovePreferenceSuccess {
    Status204(),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`set_locale`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SetLocaleSuccess {
    Status204(serde_json::Value),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`set_preference`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SetPreferenceSuccess {
    Status204(serde_json::Value),
    UnknownValue(serde_json::Value),
}
...
pub async fn delete_locale(configuration: &configuration::Configuration, ) -> Result<ResponseContent<DeleteLocaleSuccess>, Error<DeleteLocaleError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteLocaleSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_current_user(configuration: &configuration::Configuration, expand: Option<&str>) -> Result<ResponseContent<GetCurrentUserSuccess>, Error<GetCurrentUserError>> {
    let local_var_configuration = configuration;
...
pub async fn get_locale(configuration: &configuration::Configuration, ) -> Result<ResponseContent<GetLocaleSuccess>, Error<GetLocaleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetLocaleSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_preference(configuration: &configuration::Configuration, key: &str) -> Result<ResponseContent<GetPreferenceSuccess>, Error<GetPreferenceError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetPreferenceSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn remove_preference(configuration: &configuration::Configuration, key: &str) -> Result<ResponseContent<RemovePreferenceSuccess>, Error<RemovePreferenceError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<RemovePreferenceSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn set_locale(configuration: &configuration::Configuration, locale: models::Locale) -> Result<ResponseContent<SetLocaleSuccess>, Error<SetLocaleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<SetLocaleSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn set_preference(configuration: &configuration::Configuration, key: &str, body: &str) -> Result<ResponseContent<SetPreferenceSuccess>, Error<SetPreferenceError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<SetPreferenceSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
