...
pub enum CreateOrUpdateRemoteIssueLinkSuccess {
    Status200(models::RemoteIssueLinkIdentifies),
    Status201(models::RemoteIssueLinkIdentifies),
...
pub enum GetRemoteIssueLinkByIdSuccess {
    Status200(models::RemoteIssueLink),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_or_update_remote_issue_link(configuration: &configuration::Configuration, issue_id_or_key: &str, remote_issue_link_request: models::RemoteIssueLinkRequest) -> Result<ResponseContent<CreateOrUpdateRemoteIssueLinkSuccess>, Error<CreateOrUpdateRemoteIssueLinkError>> {
...
pub async fn delete_remote_issue_link_by_global_id(configuration: &configuration::Configuration, issue_id_or_key: &str, global_id: &str) -> Result<ResponseContent<DeleteRemoteIssueLinkByGlobalIdSuccess>, Error<DeleteRemoteIssueLinkByGlobalIdError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_remote_issue_link_by_id(configuration: &configuration::Configuration, issue_id_or_key: &str, link_id: &str) -> Result<ResponseContent<DeleteRemoteIssueLinkByIdSuccess>, Error<DeleteRemoteIssueLinkByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_remote_issue_link_by_id(configuration: &configuration::Configuration, issue_id_or_key: &str, link_id: &str) -> Result<ResponseContent<GetRemoteIssueLinkByIdSuccess>, Error<GetRemoteIssueLinkByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_remote_issue_links(configuration: &configuration::Configuration, issue_id_or_key: &str, global_id: Option<&str>) -> Result<ResponseContent<GetRemoteIssueLinksSuccess>, Error<GetRemoteIssueLinksError>> {
    let local_var_configuration = configuration;
...
pub async fn update_remote_issue_link(configuration: &configuration::Configuration, issue_id_or_key: &str, link_id: &str, remote_issue_link_request: models::RemoteIssueLinkRequest) -> Result<ResponseContent<UpdateRemoteIssueLinkSuccess>, Error<UpdateRemoteIssueLinkError>> {
    let local_var_configuration = configuration;
