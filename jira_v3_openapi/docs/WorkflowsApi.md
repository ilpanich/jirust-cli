...
[**list_workflow_history**](WorkflowsApi.md#list_workflow_history) | **POST** /rest/api/3/workflow/history/list | List workflow history entries
[**read_workflow_from_history**](WorkflowsApi.md#read_workflow_from_history) | **POST** /rest/api/3/workflow/history | Read workflow version from history
...
> models::DefaultWorkflowEditorResponse get_default_editor()
...
[**models::DefaultWorkflowEditorResponse**](DefaultWorkflowEditorResponse.md)
...
> models::WorkflowProjectUsageDto get_project_usages_for_workflow(workflow_id, next_page_token, max_results)
...
[**models::WorkflowProjectUsageDto**](WorkflowProjectUsageDTO.md)
...
> models::WorkflowProjectIssueTypeUsageDto get_workflow_project_issue_type_usages(workflow_id, project_id, next_page_token, max_results)
...
[**models::WorkflowProjectIssueTypeUsageDto**](WorkflowProjectIssueTypeUsageDTO.md)
...
> models::WorkflowSchemeUsageDto get_workflow_scheme_usages_for_workflow(workflow_id, next_page_token, max_results)
...
[**models::WorkflowSchemeUsageDto**](WorkflowSchemeUsageDTO.md)
...
> models::WorkflowHistoryListResponseDto list_workflow_history(workflow_history_list_request, expand)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**workflow_history_list_request** | [**WorkflowHistoryListRequest**](WorkflowHistoryListRequest.md) |  | [required] |
...
[**models::WorkflowHistoryListResponseDto**](WorkflowHistoryListResponseDTO.md)
...
> models::WorkflowHistoryReadResponseDto read_workflow_from_history(workflow_history_read_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**workflow_history_read_request** | [**WorkflowHistoryReadRequest**](WorkflowHistoryReadRequest.md) |  | [required] |

### Return type

[**models::WorkflowHistoryReadResponseDto**](WorkflowHistoryReadResponseDTO.md)
...
> models::WorkflowReadResponse read_workflows(workflow_read_request)
Bulk get workflows
