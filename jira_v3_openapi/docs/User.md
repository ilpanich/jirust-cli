...
**app_type** | Option<**String**> | The app type of the user account when accountType is 'app'. Can take the following values:   *  `service` Service Account  *  `agent` Rovo Agent Account  *  `unknown` Unknown app type | [optional][readonly]
...
**guest** | Option<**bool**> | Whether the user is a guest. | [optional][readonly]
