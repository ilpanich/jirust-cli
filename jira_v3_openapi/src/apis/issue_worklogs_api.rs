...
pub async fn bulk_move_worklogs(configuration: &configuration::Configuration, issue_id_or_key: &str, worklogs_move_request_bean: models::WorklogsMoveRequestBean, override_editable_flag: Option<bool>) -> Result<(), Error<BulkMoveWorklogsError>> {
    let local_var_configuration = configuration;
