...
pub async fn read_workflows(configuration: &configuration::Configuration, workflow_read_request: models::WorkflowReadRequest, use_approval_configuration: Option<bool>) -> Result<models::WorkflowReadResponse, Error<ReadWorkflowsError>> {
    let local_var_configuration = configuration;
