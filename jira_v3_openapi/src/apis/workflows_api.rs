...
pub async fn read_workflows(configuration: &configuration::Configuration, workflow_read_request: models::WorkflowReadRequest, expand: Option<&str>, use_transition_links_format: Option<bool>) -> Result<models::WorkflowReadResponse, Error<ReadWorkflowsError>> {
    let local_var_configuration = configuration;
