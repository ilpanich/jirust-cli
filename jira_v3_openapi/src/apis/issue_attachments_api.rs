...
pub async fn add_attachment(configuration: &configuration::Configuration, issue_id_or_key: &str, file_content: Vec<u8>, file_name: &str) -> Result<Vec<models::Attachment>, Error<AddAttachmentError>> {
...
pub async fn get_attachment_content(configuration: &configuration::Configuration, id: &str, redirect: Option<bool>) -> Result<(), Error<GetAttachmentContentError>> {
    let local_var_configuration = configuration;
...
pub async fn get_attachment_thumbnail(configuration: &configuration::Configuration, id: &str, redirect: Option<bool>, fallback_to_default: Option<bool>, width: Option<i32>, height: Option<i32>) -> Result<(), Error<GetAttachmentThumbnailError>> {
    let local_var_configuration = configuration;
