...
/// struct for typed errors of method [`get_required_workflow_scheme_mappings`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetRequiredWorkflowSchemeMappingsError {
    Status400(),
    Status401(),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`switch_workflow_scheme_for_project`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SwitchWorkflowSchemeForProjectError {
    Status400(),
    Status401(),
    Status409(),
    UnknownValue(serde_json::Value),
...
pub async fn get_project_usages_for_workflow_scheme(configuration: &configuration::Configuration, workflow_scheme_id: &str, next_page_token: Option<&str>, max_results: Option<i32>) -> Result<models::WorkflowSchemeProjectUsageDto, Error<GetProjectUsagesForWorkflowSchemeError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/3/workflowscheme/{workflowSchemeId}/projectUsages", local_var_configuration.base_path, workflowSchemeId=crate::apis::urlencode(workflow_scheme_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectUsagesForWorkflowSchemeError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_required_workflow_scheme_mappings(configuration: &configuration::Configuration, workflow_scheme_update_required_mappings_request: models::WorkflowSchemeUpdateRequiredMappingsRequest) -> Result<models::WorkflowSchemeUpdateRequiredMappingsResponse, Error<GetRequiredWorkflowSchemeMappingsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRequiredWorkflowSchemeMappingsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn read_workflow_schemes(configuration: &configuration::Configuration, workflow_scheme_read_request: models::WorkflowSchemeReadRequest) -> Result<Vec<models::WorkflowSchemeReadResponse>, Error<ReadWorkflowSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn switch_workflow_scheme_for_project(configuration: &configuration::Configuration, workflow_scheme_project_switch_bean: models::WorkflowSchemeProjectSwitchBean) -> Result<(), Error<SwitchWorkflowSchemeForProjectError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/rest/api/3/workflowscheme/project/switch", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&workflow_scheme_project_switch_bean);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SwitchWorkflowSchemeForProjectError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
