...
pub async fn create_related_work(
    configuration: &configuration::Configuration,
    id: &str,
    version_related_work: models::VersionRelatedWork,
) -> Result<models::VersionRelatedWork, Error<CreateRelatedWorkError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateRelatedWorkError> =
...
pub async fn delete_and_replace_version(
    configuration: &configuration::Configuration,
    id: &str,
    delete_and_replace_version_bean: models::DeleteAndReplaceVersionBean,
...
pub async fn delete_related_work(
    configuration: &configuration::Configuration,
    version_id: &str,
    related_work_id: &str,
) -> Result<(), Error<DeleteRelatedWorkError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        relatedWorkId = crate::apis::urlencode(related_work_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteRelatedWorkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_related_work(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<Vec<models::VersionRelatedWork>, Error<GetRelatedWorkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRelatedWorkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn move_version(
    configuration: &configuration::Configuration,
    id: &str,
    version_move_bean: models::VersionMoveBean,
...
pub async fn update_related_work(
    configuration: &configuration::Configuration,
    id: &str,
    version_related_work: models::VersionRelatedWork,
) -> Result<models::VersionRelatedWork, Error<UpdateRelatedWorkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateRelatedWorkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
