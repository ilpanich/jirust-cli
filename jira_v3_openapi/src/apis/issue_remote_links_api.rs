...
pub async fn get_remote_issue_links(configuration: &configuration::Configuration, issue_id_or_key: &str, global_id: Option<&str>) -> Result<models::GetRemoteIssueLinks200Response, Error<GetRemoteIssueLinksError>> {
    let local_var_configuration = configuration;
