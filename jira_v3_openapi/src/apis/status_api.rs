...
/// struct for typed errors of method [`get_statuses_by_name`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetStatusesByNameError {
    Status400(),
    Status401(),
    UnknownValue(serde_json::Value),
}
...
pub async fn get_project_issue_type_usages_for_status(configuration: &configuration::Configuration, status_id: &str, project_id: &str, next_page_token: Option<&str>, max_results: Option<i32>) -> Result<models::StatusProjectIssueTypeUsageDto, Error<GetProjectIssueTypeUsagesForStatusError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/3/statuses/{statusId}/project/{projectId}/issueTypeUsages", local_var_configuration.base_path, statusId=crate::apis::urlencode(status_id), projectId=crate::apis::urlencode(project_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectIssueTypeUsagesForStatusError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_project_usages_for_status(configuration: &configuration::Configuration, status_id: &str, next_page_token: Option<&str>, max_results: Option<i32>) -> Result<models::StatusProjectUsageDto, Error<GetProjectUsagesForStatusError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/3/statuses/{statusId}/projectUsages", local_var_configuration.base_path, statusId=crate::apis::urlencode(status_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectUsagesForStatusError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_statuses_by_id(configuration: &configuration::Configuration, id: Vec<String>) -> Result<Vec<models::JiraStatus>, Error<GetStatusesByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_statuses_by_name(configuration: &configuration::Configuration, name: Vec<String>, project_id: Option<&str>) -> Result<Vec<models::JiraStatus>, Error<GetStatusesByNameError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/rest/api/3/statuses/byNames", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    local_var_req_builder = match "multi" {
        "multi" => local_var_req_builder.query(&name.into_iter().map(|p| ("name".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => local_var_req_builder.query(&[("name", &name.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetStatusesByNameError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_workflow_usages_for_status(configuration: &configuration::Configuration, status_id: &str, next_page_token: Option<&str>, max_results: Option<i32>) -> Result<models::StatusWorkflowUsageDto, Error<GetWorkflowUsagesForStatusError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/3/statuses/{statusId}/workflowUsages", local_var_configuration.base_path, statusId=crate::apis::urlencode(status_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetWorkflowUsagesForStatusError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn search(configuration: &configuration::Configuration, project_id: Option<&str>, start_at: Option<i64>, max_results: Option<i32>, search_string: Option<&str>, status_category: Option<&str>) -> Result<models::PageOfStatuses, Error<SearchError>> {
    let local_var_configuration = configuration;
