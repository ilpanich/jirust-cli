...
pub struct PageBean2FieldAssociationSchemeProjectSearchResult {
    ...
    pub values: Option<Vec<models::FieldAssociationSchemeProjectSearchResult>>,
}

impl PageBean2FieldAssociationSchemeProjectSearchResult {
    /// A page of items.
    pub fn new() -> PageBean2FieldAssociationSchemeProjectSearchResult {
