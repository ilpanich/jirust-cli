...
pub struct PageBean2FieldAssociationSchemeFieldSearchResult {
    ...
    pub values: Option<Vec<models::FieldAssociationSchemeFieldSearchResult>>,
}

impl PageBean2FieldAssociationSchemeFieldSearchResult {
    /// A page of items.
    pub fn new() -> PageBean2FieldAssociationSchemeFieldSearchResult {
