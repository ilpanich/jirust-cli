...
pub struct PageBean2GetProjectsWithFieldSchemesResponse {
    ...
    pub values: Option<Vec<models::GetProjectsWithFieldSchemesResponse>>,
}

impl PageBean2GetProjectsWithFieldSchemesResponse {
    /// A page of items.
    pub fn new() -> PageBean2GetProjectsWithFieldSchemesResponse {
