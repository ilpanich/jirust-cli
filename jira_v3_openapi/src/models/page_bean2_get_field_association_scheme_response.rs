...
pub struct PageBean2GetFieldAssociationSchemeResponse {
    ...
    pub values: Option<Vec<models::GetFieldAssociationSchemeResponse>>,
}

impl PageBean2GetFieldAssociationSchemeResponse {
    /// A page of items.
    pub fn new() -> PageBean2GetFieldAssociationSchemeResponse {
