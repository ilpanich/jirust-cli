...
**values** | Option<[**Vec<models::NotificationSchemeAndProjectMappingJsonBean>**](NotificationSchemeAndProjectMappingJsonBean.md)> | The list of items. | [optional][readonly]
