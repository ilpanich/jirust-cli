...
mod tests {
    ...
    fn test_config_serialization() {
        ...
        let deserialized: ConfigFile = serde_json::from_str(&serialized).expect("Failed to deserialize config");
    ...
    fn test_jira_section_clone() {
        ...
        assert_eq!(config.get_standard_resolution(), cloned.get_standard_resolution());
        assert_eq!(config.get_standard_resolution_comment(), cloned.get_standard_resolution_comment());
    }
